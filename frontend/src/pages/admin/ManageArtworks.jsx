        ...
        {filteredArtworks.map((art) => (
          <Card key={art.id} className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
            <CardContent className="p-4 space-y-6">
              <section>
                <h3 className="text-sm font-semibold text-amber-600 uppercase tracking-wide mb-2">📎 Metadata</h3>
              ...
              <section>
                <h3 className="text-sm font-semibold text-amber-600 uppercase tracking-wide mb-2">🖼️ Artwork Info</h3>
              ...
              <section>
                <h3 className="text-sm font-semibold text-amber-600 uppercase tracking-wide mb-2">✍️ Creative Details</h3>
                <div className="grid md:grid-cols-2 gap-4">
              ...
              <section>
                <h3 className="text-sm font-semibold text-amber-600 uppercase tracking-wide mb-2">⚙️ Controls</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="min-h-[48px] flex items-center justify-between sm:justify-start gap-4">
                    <label htmlFor={`featured-${art.id}`} className="text-sm font-medium text-gray-700 whitespace-nowrap">
                      Featured
                    </label>
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => handleChange(art.id, "featured", e.target.checked)}
                        className="w-5 h-5 text-gray-700 border-gray-300 rounded focus:ring-2 focus:ring-offset-1 focus:ring-gray-400"
                      />
                      <span className="text-sm text-gray-600">{art.featured ? "Yes" : "No"}</span>
                    </div>
                  </div>
              ...
              <section>
                <h3 className="text-sm font-semibold text-amber-600 uppercase tracking-wide mb-2">🖼️ Images</h3>
